  ...
  case 'SY'	% My own fit to the data (soon to come)
  case 'Ji'	% Ji 2018 Yield
...
%if any(isinf(Y.nn2o_nden_nh4)|isinf(Y.no2_nden_nh4)|isinf(Y.no2_hx_nh4))
%   error(['infinite N2O yield']);
%end	% End function
